...
})({"k7IQl":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "3019ca71b1c48e4e";
...
},{}],"3KY7U":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require("./helpers/bundle-url").getBundleURL("482qr") + "index.2d5a6a21.css" + "?" + Date.now());
...
},{}],"aUct6":[function(require,module,exports) {
var _tinySlider = require("tiny-slider/src/tiny-slider");
var _tinySliderScss = require("/node_modules/tiny-slider/src/tiny-slider.scss");
...
},{"tiny-slider/src/tiny-slider":"9yajy","/node_modules/tiny-slider/src/tiny-slider.scss":"bZm17"}],"9yajy":[function(require,module,exports) {
    ...
    var transformCore = function() {
        return carousel ? function() {
            ...
            if (TRANSITIONDURATION || !speed1) {
                ...
                if (!speed1 || !(0, _isVisibleJs.isVisible)(container)) onTransitionEnd();
            } else // for old browser with non-zero duration
            (0, _jsTransformJs.jsTransform)(container, transformAttr, transformPrefix, transformPostfix, getContainerTransformValue(), speed1, onTransitionEnd);
            ...
            (0, _addEventsJs.addEvents)(slideItems[index1], eve);
            animateSlide(indexCached, animateIn, animateOut, true);
            animateSlide(index1, animateNormal, animateIn);
            // run fallback function manually
            // when transition or animation not supported / duration is 0
            if (!TRANSITIONEND || !ANIMATIONEND || !speed1 || !(0, _isVisibleJs.isVisible)(container)) onTransitionEnd();
        };
    }();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bZm17":[function() {},{}]},["k7IQl","3KY7U","aUct6"], "aUct6", "parcelRequire1ff3")

//# sourceMappingURL=index.b1c48e4e.js.map
